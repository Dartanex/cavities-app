    ...
    return (
        <header className="bg-white/40 shadow-md w-full md:max-w-screen-xl sticky z-20 top-0 left-0 backdrop-blur-md">
            <nav className="mx-auto md:flex md:flex-row md:items-center md:justify-between  gap-5 md:px-10 px-7">
                ...
                <div className={`absolute md:static md:min-h-fit left-0 w-full md:w-auto flex items-center 
                px-5 transition-all duration-500 ease-in ${open ? 'top-25 bg-black/90 backdrop-blur-sm md:bg-transparent' : 'hidden md:flex'} `}>
